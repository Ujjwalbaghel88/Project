                    ...
                    <div className="flex flex-wrap gap-1.5 mb-3">
                        {foodTypes.map((type) => (
                            <button
                                ...
                                className={`flex items-center gap-1 text-xs px-2.5 py-1 rounded-full border transition ${activeFoodType === type
                ...
                <div className="flex gap-1.5 overflow-x-auto pb-1">
                    {categories.map((cat) => (
                        <button
                            ...
                            className={`shrink-0 text-xs px-3 py-1.5 rounded-full border transition ${activeCategory === cat
                                    ? "bg-(--color-primary) text-(--color-primary-content) border-(--color-primary)"
                                    : "bg-white border-(--color-base-300) text-(--color-base-content) hover:border-(--color-primary)"
                                }`}
                        >
